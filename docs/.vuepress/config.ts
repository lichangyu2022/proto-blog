...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    nav: [
      ...
      {
        text: '逆向',
        link: '/reverse/', //目录页链接，此处link是vdoing主题新增的配置项，有二级导航时，可以点击一级导航跳到目录页
        items: [
          {
            text: '汇编',
            link: '/pages/7a5291/',
    ...
    logo: '/img/PROTO.png', // 导航栏logo
    repo: 'lichangyu2022', // 导航栏右侧生成Github链接
    ...
    author: {
      name: 'Proto', // 必需
      link: 'https://github.com/lichangyu2022', // 可选的
    },
  ...
  /*  footer: {
      ...
      copyrightInfo:
        'Proto | <a href="https://github.com/lichangyu2022/vuepress-theme-vdoing/blob/master/LICENSE" target="_blank">MIT License</a>', // 博客版权信息，支持a标签或换行标签</br>
    },
*/
  ...
  head: [
    ['link', { rel: 'icon', href: '/img/PROTO.png' }], //favicons，资源放在public文件夹
  ...
  plugins: <UserPlugins>[
   ...
   /* [
      'vuepress-plugin-comment', // 评论
      {
        choosen: 'gitalk',
        options: {
          clientID: '8a87e0dda54dc33eed72',
          clientSecret: 'bb057d31222e8b4c322f2ebbe0e9d7cbdcbb7f2d',
          repo: 'testblog', // GitHub 仓库
          owner: 'lichangyu2022', // GitHub仓库所有者
          admin: ['Proto'], // 对仓库有写权限的人
